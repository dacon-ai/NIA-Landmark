...
from delf.python.training.datasets import landmarks as kld
...
flags.DEFINE_enum(
    'dataset_version', 'kld_v1', ['kld_v1'],
    'Korea Landmarks dataset version, used to determine the'
    'number of classes.')
